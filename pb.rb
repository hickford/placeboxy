...
module Pb::Views
  def layout
    html do
      ...
      body do
         text! ' <a href="https://github.com/hickford/placeboxy"><img style="position: absolute; top: 0; right: 0; border: 0;" src="https://s3.amazonaws.com/github/ribbons/forkme_right_red_aa0000.png" alt="Fork me on GitHub"></a>'
            a :href=>R(Index) do
                h1 "Placeboxy"
            end
